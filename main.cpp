...
Servo RampServo; //12 servos max
#define SERVO_IGNITION_PIN 9
#define RAMP_IGNITION_PIN 10
...
//Servos
  /*
IgnitionServo.attach(SERVO_IGNITION_PIN);
RampServo.attach(RAMP_IGNITION_PIN);
*/
